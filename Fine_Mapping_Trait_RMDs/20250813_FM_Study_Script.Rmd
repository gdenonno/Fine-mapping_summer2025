...
NOTE: we have been doing all our work in genome build hg19 because vcf tools requires a different version for hg38. Note that this means all files will be converted to hg19 / all 1000 genomes files will be hg19.
...
Learn more about MuungeSumstats here: https://www.bioconductor.org/packages/release/bioc/html/MungeSumstats.html
